  ...
  return (
    <Modal onClose={onCancel} isLoading={isDeleting}>
      <div className="text-center space-y-6">
        ...
        {/* Title */}
        <h3 className="text-xl font-semibold text-gray-900">Delete Program</h3>

        {/* Warning Message */}
        <div className="space-y-3 text-sm text-gray-600">
          <p>
            Are you sure you want to delete{" "}
            <span className="font-semibold text-gray-900">{programTitle}</span>?
          </p>
          <p className="text-red-600 font-medium">
            This action cannot be undone. This will permanently:
          </p>
          <ul className="text-left list-disc list-inside space-y-1 text-gray-700">
            <li>Remove program from all days</li>
            <li>Delete all program-department-user assignments</li>
            <li>Delete the program</li>
          </ul>
        </div>
